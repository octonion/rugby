...
drop table if exists rr._schedule_factors;

create table rr._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
