...
psql rugby -c "drop table if exists ercc.results;"

psql rugby -f sos/standardized_results.sql

psql rugby -c "vacuum full verbose analyze ercc.results;"

psql rugby -c "drop table if exists ercc._zinb_basic_factors;"
psql rugby -c "drop table if exists ercc._zinb_parameter_levels;"

#R --vanilla -f sos/zinb.R
R -f sos/zinb.R

psql rugby -c "vacuum full verbose analyze ercc._zinb_parameter_levels;"
psql rugby -c "vacuum full verbose analyze ercc._zinb_basic_factors;"

psql rugby -f sos/zinb_normalize_factors.sql
psql rugby -c "vacuum full verbose analyze ercc._zinb_factors;"

psql rugby -f sos/zinb_schedule_factors.sql
psql rugby -c "vacuum full verbose analyze ercc._zinb_schedule_factors;"
