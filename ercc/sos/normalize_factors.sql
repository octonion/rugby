...
drop table if exists ercc._factors;

create table ercc._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from ercc._parameter_levels npl
left outer join ercc._basic_factors nbf
