...
drop table if exists ercc._schedule_factors;

create table ercc._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
