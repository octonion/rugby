...
drop table if exists ercc._zinb_factors;

create table ercc._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be reerccitten agnostically
...
insert into ercc._zinb_factors
...
from ercc._zinb_parameter_levels npl
left outer join ercc._zinb_basic_factors nbf
