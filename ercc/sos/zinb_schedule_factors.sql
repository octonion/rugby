...
drop table if exists ercc._zinb_schedule_factors;

create table ercc._zinb_schedule_factors (
	team_name			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into ercc._zinb_schedule_factors
(team_name,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from ercc._zinb_factors o
left outer join ercc._zinb_factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update ercc._zinb_schedule_factors
...
strength=o.strength
from ercc._zinb_schedule_factors o
