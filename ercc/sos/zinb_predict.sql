...
join ercc._zinb_schedule_factors sf1
  on (sf1.team_id)=(t1.team_id)
join ercc._zinb_schedule_factors sf2
  on (sf2.team_id)=(t2.team_id)

join ercc._factors o
  on (o.parameter,o.level)=('field','offense_home')
join ercc._factors d
  on (d.parameter,d.level)=('field','defense_home')

join ercc._zinb_basic_factors i
  on (i.factor)=('(Intercept)')

join ercc._zinb_basic_factors z
  on (z.factor)=('pz')
