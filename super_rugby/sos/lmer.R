...
dbWriteTable(con,c("sr","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("sr","_basic_factors"),as.data.frame(combined),row.names=TRUE)
