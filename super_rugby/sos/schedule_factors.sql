...
drop table if exists sr._schedule_factors;

create table sr._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
