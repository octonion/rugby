...
drop table if exists bunnings._schedule_factors;

create table bunnings._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into bunnings._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from bunnings._factors o
left outer join bunnings._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update bunnings._schedule_factors
...
strength=o.strength
from bunnings._schedule_factors o
