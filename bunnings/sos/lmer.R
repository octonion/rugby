...
dbWriteTable(con,c("bunnings","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("bunnings","_basic_factors"),as.data.frame(combined),row.names=TRUE)
