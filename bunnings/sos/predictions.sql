...
from bunnings.games g
join bunnings._schedule_factors sf1
  on (sf1.team_id)=(g.home_team)
join bunnings._schedule_factors sf2
  on (sf2.team_id)=(g.away_team)

join bunnings._factors o
  on (o.parameter,o.level)=('field','offense_home')
join bunnings._factors d
  on (d.parameter,d.level)=('field','defense_home')

join bunnings._basic_factors i
