...
drop table if exists pro14._schedule_factors;

create table pro14._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from pro14._schedule_factors o
