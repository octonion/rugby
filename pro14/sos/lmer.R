...
dbWriteTable(con,c("pro14","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("pro14","_basic_factors"),as.data.frame(combined),row.names=TRUE)
