...
drop table if exists men._zinb_schedule_factors;

create table men._zinb_schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from men._zinb_schedule_factors o
