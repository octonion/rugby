...
drop table if exists wr._men_zinb_factors;

create table wr._men_zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
insert into wr._men_zinb_factors
...
from wr._men_zinb_parameter_levels npl
left outer join wr._men_zinb_basic_factors nbf
