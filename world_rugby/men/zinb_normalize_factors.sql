...
drop table if exists men._zinb_factors;

create table men._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be remenitten agnostically
...
from men._zinb_parameter_levels npl
left outer join men._zinb_basic_factors nbf
