...
drop table if exists wr._men_schedule_factors;

create table wr._men_schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from wr._men_schedule_factors o
...
from rs
where
  (wr._men_schedule_factors.team_id)=(rs.team_id);
