...
drop table if exists men._schedule_factors;

create table men._schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
from rs
where
  (men._schedule_factors.team_id)=(rs.team_id);
