...
drop table if exists u20._zinb_schedule_factors;

create table u20._zinb_schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from u20._zinb_schedule_factors o
