...
dbWriteTable(con,c("u20","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("u20","_basic_factors"),as.data.frame(combined),row.names=TRUE)
