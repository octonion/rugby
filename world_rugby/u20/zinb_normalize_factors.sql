...
drop table if exists u20._zinb_factors;

create table u20._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be reu20itten agnostically
...
from u20._zinb_parameter_levels npl
left outer join u20._zinb_basic_factors nbf
