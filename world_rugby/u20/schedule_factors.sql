...
drop table if exists u20._schedule_factors;

create table u20._schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
from rs
where
  (u20._schedule_factors.team_id)=(rs.team_id);
