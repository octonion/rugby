...
drop table if exists women_7s._schedule_factors;

create table women_7s._schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from women_7s._schedule_factors o
...
from rs
where
  (women_7s._schedule_factors.team_id)=(rs.team_id);
