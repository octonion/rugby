...
drop table if exists women_7s._zinb_schedule_factors;

create table women_7s._zinb_schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into women_7s._zinb_schedule_factors
(team_id,offensive,defensive)
(
select o.level::integer,o.exp_factor,d.exp_factor
from women_7s._zinb_factors o
left outer join women_7s._zinb_factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update women_7s._zinb_schedule_factors
...
strength=o.strength
from women_7s._zinb_schedule_factors o
