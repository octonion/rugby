...
drop table if exists women_7s._factors;

create table women_7s._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from women_7s._parameter_levels npl
left outer join women_7s._basic_factors nbf
