...
join women_7s._zinb_schedule_factors sf1
  on (sf1.team_id)=(t1.team_id)
join women_7s._zinb_schedule_factors sf2
...
join women_7s._zinb_basic_factors i
  on (i.factor)=('(Intercept)')

join women_7s._zinb_basic_factors z
  on (z.factor)=('pz')
