...
drop table if exists wr._zinb_factors;

create table wr._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from wr._zinb_parameter_levels npl
left outer join wr._zinb_basic_factors nbf
