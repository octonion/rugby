...
drop table if exists women._zinb_factors;

create table women._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be rewomenitten agnostically
...
insert into women._zinb_factors
...
from women._zinb_parameter_levels npl
left outer join women._zinb_basic_factors nbf
