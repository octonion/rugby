...
drop table if exists wr._women_zinb_factors;

create table wr._women_zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
insert into wr._women_zinb_factors
...
from wr._women_zinb_parameter_levels npl
left outer join wr._women_zinb_basic_factors nbf
