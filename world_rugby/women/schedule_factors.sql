...
drop table if exists women._schedule_factors;

create table women._schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from women._schedule_factors o
...
from rs
where
  (women._schedule_factors.team_id)=(rs.team_id);
