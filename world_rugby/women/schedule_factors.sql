...
drop table if exists wr._women_schedule_factors;

create table wr._women_schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from wr._women_schedule_factors o
...
from rs
where
  (wr._women_schedule_factors.team_id)=(rs.team_id);
