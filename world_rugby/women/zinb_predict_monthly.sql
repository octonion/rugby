...
join wr._women_zinb_schedule_factors sf1
  on (sf1.team_id)=(t1.team_id)
join wr._women_zinb_schedule_factors sf2
  on (sf2.team_id)=(t2.team_id)

join wr._women_factors o
  on (o.parameter,o.level)=('field','offense_home')
join wr._women_factors d
  on (d.parameter,d.level)=('field','defense_home')

join wr._women_zinb_basic_factors i
  on (i.factor)=('(Intercept)')

join wr._women_zinb_basic_factors z
  on (z.factor)=('pz')
