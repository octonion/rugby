...
drop table if exists men_7s._schedule_factors;

create table men_7s._schedule_factors (
	team_id			integer,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from men_7s._schedule_factors o
...
from rs
where
  (men_7s._schedule_factors.team_id)=(rs.team_id);
