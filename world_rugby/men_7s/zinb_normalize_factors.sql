...
drop table if exists men_7s._zinb_factors;

create table men_7s._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be remen_7sitten agnostically
...
insert into men_7s._zinb_factors
...
from men_7s._zinb_parameter_levels npl
left outer join men_7s._zinb_basic_factors nbf
