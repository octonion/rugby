...
dbWriteTable(con,c("men_7s","_zinb_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("men_7s","_zinb_basic_factors"),as.data.frame(combined),row.names=TRUE)
