...
drop table if exists sl._schedule_factors;

create table sl._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
