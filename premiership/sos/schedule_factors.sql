...
drop table if exists premiership._schedule_factors;

create table premiership._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into premiership._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from premiership._factors o
left outer join premiership._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update premiership._schedule_factors
...
strength=o.strength
from premiership._schedule_factors o
