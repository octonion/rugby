...
dbWriteTable(con,c("premiership","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("premiership","_basic_factors"),as.data.frame(combined),row.names=TRUE)
