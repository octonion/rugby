...
drop table if exists premiership._zinb_factors;

create table premiership._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be repremiershipitten agnostically
...
insert into premiership._zinb_factors
...
from premiership._zinb_parameter_levels npl
left outer join premiership._zinb_basic_factors nbf
...
update premiership._zinb_factors
