...
drop table if exists premiership._zinb_schedule_factors;

create table premiership._zinb_schedule_factors (
	team_name			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into premiership._zinb_schedule_factors
(team_name,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from premiership._zinb_factors o
left outer join premiership._zinb_factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update premiership._zinb_schedule_factors
...
strength=o.strength
from premiership._zinb_schedule_factors o
...
from premiership._zinb_factors f
