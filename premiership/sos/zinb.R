...
dbWriteTable(con,c("premiership","_zinb_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("premiership","_zinb_basic_factors"),as.data.frame(combined),row.names=TRUE)
