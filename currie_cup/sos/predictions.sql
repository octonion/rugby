...
(exp(i.estimate)*sf2.offensive*d.exp_factor*sf1.defensive))::numeric(4,2) as e_d

from club.games g
join club._schedule_factors sf1
  on (sf1.team_id)=(g.home_team)
join club._schedule_factors sf2
