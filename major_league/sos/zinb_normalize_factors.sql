...
drop table if exists major_league._zinb_factors;

create table major_league._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be remajor_leagueitten agnostically
...
insert into major_league._zinb_factors
...
from major_league._zinb_parameter_levels npl
left outer join major_league._zinb_basic_factors nbf
...
update major_league._zinb_factors
