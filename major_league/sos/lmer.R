...
dbWriteTable(con,c("major_league","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("major_league","_basic_factors"),as.data.frame(combined),row.names=TRUE)
