...
drop table if exists major_league._schedule_factors;

create table major_league._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into major_league._schedule_factors
(team_id,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from major_league._factors o
left outer join major_league._factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update major_league._schedule_factors
...
strength=o.strength
from major_league._schedule_factors o
