...
drop table if exists m10._factors;

create table m10._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from m10._parameter_levels npl
left outer join m10._basic_factors nbf
