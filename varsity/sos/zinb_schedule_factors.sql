...
drop table if exists varsity._zinb_schedule_factors;

create table varsity._zinb_schedule_factors (
	team_name			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into varsity._zinb_schedule_factors
(team_name,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from varsity._zinb_factors o
left outer join varsity._zinb_factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update varsity._zinb_schedule_factors
...
strength=o.strength
from varsity._zinb_schedule_factors o
