...
drop table if exists varsity._zinb_factors;

create table varsity._zinb_factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
-- this can/should be revarsityitten agnostically
...
insert into varsity._zinb_factors
...
from varsity._zinb_parameter_levels npl
left outer join varsity._zinb_basic_factors nbf
