...
dbWriteTable(con,c("varsity","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("varsity","_basic_factors"),as.data.frame(combined),row.names=TRUE)
