...
drop table if exists varsity._schedule_factors;

create table varsity._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
strength=o.strength
from varsity._schedule_factors o
