...
drop table if exists nrl._schedule_factors;

create table nrl._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
