...
drop table if exists nrl._factors;

create table nrl._factors (
       parameter		text,
       level			text,
       type			text,
       method			text,
...
from nrl._parameter_levels npl
left outer join nrl._basic_factors nbf
