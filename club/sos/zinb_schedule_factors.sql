...
drop table if exists club._zinb_schedule_factors;

create table club._zinb_schedule_factors (
	team_name			text,
        offensive               float,
        defensive		float,
        strength                float,
...
insert into club._zinb_schedule_factors
(team_name,offensive,defensive)
(
select o.level,o.exp_factor,d.exp_factor
from club._zinb_factors o
left outer join club._zinb_factors d
  on (d.level,d.parameter)=(o.level,'defense')
where o.parameter='offense'
);

update club._zinb_schedule_factors
...
strength=o.strength
from club._zinb_schedule_factors o
